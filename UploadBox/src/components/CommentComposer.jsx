...
import sanitizeHtml from 'sanitize-html'; // Client-side input sanitation
...
const CommentComposer = ({refresh, update}) => {
    ...
    const handleSubmit = async (event) => {
        ...
        // Sanitize input before sending to the server
        const sanitizedInput = sanitizeHtml(iptxt, {
            allowedTags: [],
            allowedAttributes: {},
        });
        ...
        try {
            const jsonBody = JSON.stringify({
                ...
                /* changed commenttxt: iptxt */
                commenttxt: sanitizedInput
            });
