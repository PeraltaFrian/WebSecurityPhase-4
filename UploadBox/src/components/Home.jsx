...
function loggedInView(user, fileStatus, setFileStatus, selectedFile, setSelectedFile, uploadCount, setUploadCount) {
    ...
    // Sanitize file name: replace potentially dangerous characters
    ...
    const handleFileChange = (e) => {
        ...
        if (file) {
            ...
            /* changed **setFileStatus(`${file.name}`); */
            setFileStatus(safeFileName); 
        } else {
            setFileStatus('NONE');
        }
    };
        ...
        <section id="file-upload-section">
            ...
            <form id="file-upload-form">
                <div id="fileinput-div">
                    ...
                    {/*{fileStatus && <p className="txt status-msg">*/}
                    {fileStatus && fileStatus !== 'NONE' && (
                        <p className="txt status-msg">
                            <span className="label">File selected: </span>{fileStatus}
                        </p>
                    )}
                </div>
